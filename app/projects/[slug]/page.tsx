...
export default async function ProjectPage({ params }: Props) {
  ...
  const correctionHref = `mailto:editors@microgridmedia.com?subject=${encodeURIComponent(`Microgrid Projects correction: ${project.name}`)}&body=${encodeURIComponent(`Project: ${project.name}\nRecord: https://microgridprojects.com/projects/${project.slug}\n\nSuggested correction or update:\n`)}`;
