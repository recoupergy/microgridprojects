      ...
      <section className="content-section">
        <div className="container record-grid">
          <article className="prose">
            ...
            <p>The modern directory was reconstructed from the original WordPress map, individual project pages, and editorial sources. We preserved {projectCount} unique geocoded records, recovered the historical detail pages, and completed a 2026 source-enrichment pass across every project—prioritizing owner, operator, government, utility, university, regulator, and equipment-supplier evidence.</p>
            ...
            <h2>Data quality</h2>
            <p>The recovered archive primarily reflects research published between 2015 and 2017, while the portfolio-wide enrichment extends through 2026. Projects may have changed owners, technologies, capacity, scope, or operating status. Every record shows its research date, evidence depth, sources, and a correction path.</p>
