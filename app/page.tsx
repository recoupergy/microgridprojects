...
const structuredData = [
  {
    ...
    "@type": "Organization",
    "@id": "https://microgridprojects.com/#organization",
    name: siteContact.organization,
    url: siteContact.website,
  ...
  },
  {
    ...
    creator: { "@id": "https://microgridprojects.com/#organization" },
    publisher: { "@id": "https://microgridprojects.com/#organization" },
    dateModified: "2026-07-19",
    inLanguage: "en-US",
    keywords: ["microgrid", "distributed energy", "energy resilience", "island power", "community energy"],
